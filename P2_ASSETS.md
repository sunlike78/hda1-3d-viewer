...
Публичные материалы P2:

- `assets/p2/hda1_p2_main_node_photoreal.png` — проверенный фотореалистичный разрез;
- `assets/p2/hda1_p2_ga02_ru.png` — сборочный лист GA-02 на русском;
- `assets/p2/hda1_p2_ga02_ru.svg` — исходный вектор GA-02;
- `assets/p2/hda1_p2_ga02_ru.dxf` — нативный CAD-лист A3 (DXF R2013, слои и размерные примитивы);
- `assets/p2/hda1_p2_mobile_preview_ru.pdf` — двухстраничный просмотр: фоторендер для телефона и лист GA-02 A3;
...
- `assets/p2/p2_qa_report_ru.md` — цифровая проверка.

Статус: предконструкторская разработка P2. Это не КД для изготовления сосуда под давлением и не сертификация.
